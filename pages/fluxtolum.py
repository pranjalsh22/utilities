...
#-------------------------------------------------FIND LUMINOSIY------------------------------------------------
 ...
 #- - - - - - - - - - - - - - - - - - - -CHECK MONOTONICALLY INCREASING- - - - - - - - - - - - - - - - 
        ...
        fig, ax = plt.subplots()
        plt.fill_between(np.linspace(0,9.12e-7,5),np.linspace(10**50,10**50,5),alpha=0.3,label='radio')
        plt.fill_between(np.linspace(9.12e-7,9.12e-4,5),np.linspace(10**50,10**50,5),alpha=0.3,label='microwave')
        plt.fill_between(np.linspace(9.12e-4,0.0912,5),np.linspace(10**50,10**50,5),alpha=0.3,label='infrared')
        plt.fill_between(np.linspace(0.0912,0.228,5),np.linspace(10**50,10**50,5),alpha=0.3,label='visible')
        plt.fill_between(np.linspace(0.228,9.12,5),np.linspace(10**50,10**50,5),alpha=0.3,label='UV')
        plt.fill_between(np.linspace(9.12,9120,5),np.linspace(10**50,10**50,5),alpha=0.3,label='X-ray')
        plt.fill_between(np.linspace(9120,9.12e10,5),np.linspace(10**50,10**50,5),alpha=0.3,label='Gamma-ray')
